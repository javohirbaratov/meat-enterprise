...
function UploaderProdCombineModal() {
  /* Form */
  ...
  /* API */
  const prodSpareRes = useGetUploaderSpareProductsQuery();
...
export default UploaderProdCombineModal;
