...
import { useAddUploaderReturnProductsSetPolkaMutation } from "../../../../features/uploader/returnProducts/uploaderReturnProductsApiSlice";

function UploaderReturnProductPutPolkaModal(props, ref) {
  ...
  /* API */
  const [addPolka] = useAddUploaderReturnProductsSetPolkaMutation();
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const data = {
        vozvrat_id: openModal?.data.orderId,
...
export default forwardRef(UploaderReturnProductPutPolkaModal);
