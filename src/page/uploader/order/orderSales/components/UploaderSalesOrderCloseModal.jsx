...
function UploaderSalesOrderCloseModal(props, ref) {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const data = {
        sale_order_id: openMadal?.data?.salesOrderId,
        sale_order_item_id: openMadal?.data?.salesOrderItemId,
        izoh: values?.comment,
      };
...
export default forwardRef(UploaderSalesOrderCloseModal);
