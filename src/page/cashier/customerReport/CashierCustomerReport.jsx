...
import { useGetCashierCustomerReportByDateMutation } from "../../../features/cashier/customerReport/cashierReportApiSlice";
import { useGetCashierSupplierQuery } from "../../../features/cashier/supplier/cashierSupplierApiSlice";
import formatCurrency from "../../../util/formatCurrency";

function CashierCustomerReport() {
  /* Ref */
  ...
  /* API */
  const providerRes = useGetCashierSupplierQuery();
  const [getDataByDate] = useGetCashierCustomerReportByDateMutation();
  ...
  const providerOptions = useMemo(() => {
    if (
      ...
      providerRes?.data?.data?.list &&
      Array.isArray(providerRes?.data?.data?.list)
    ) {
      return providerRes?.data.data?.list;
    }
    return [];
  }, [providerRes?.data]);
...
export default CashierCustomerReport;
