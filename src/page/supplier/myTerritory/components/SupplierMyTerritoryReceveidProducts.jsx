...
import { useGetSupplierMyTerritoryReceivedProductQuery } from "../../../../features/supplier/myTerritory/supplierMyTerritoryApiSlice";

function SupplierMyTerritoryReceveidProducts() {
  // State
  const [selectedDate, setSelectedDate] = useState({ start: null, end: null });

  // Api
  const { data, isLoading, isError, refetch, isFetching } =
    useGetSupplierMyTerritoryReceivedProductQuery(selectedDate);
    ...
    <>
      ...
      <MainDataTable
        ...
        customHeader={
          <ExportTable
            columns={columns}
            fileName="Dostavkachi-olingan pullar"
            data={[...filterData]}
          />
        }
        refetch={refetch}
...
export default SupplierMyTerritoryReceveidProducts;
