...
import SalesProductSaleCheckoutAction from "./SalesProductSaleCheckoutAction";

function SalesProductSaleCheckout({ productsData = [], onRestart }) {
  /* Ref */
  ...
  return (
    <>
      ...
      <MainModal
        ...
        width={600}
      >
        <SalesProductSaleCheckoutAction
...
export default SalesProductSaleCheckout;
