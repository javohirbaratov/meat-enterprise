...
import { Button, Divider, Form, Input, Switch, Typography, message } from "antd";
...
function SalesUploaderCheckout({
  onSuccess,
  allProducts,
  totalPrice,
  onClose,
  ...
  return (
    <>
      ...
      >
        ...
        <Divider />
        <MainText>
          Mijoz nomi: <b>{customerData?.fio}</b>{" "}
        </MainText>
        <MainText>
          Mahsulotlar{" "}
          <b>
            {allProducts.length} <span style={{ opacity: "0.5" }}>ta</span>
          </b>{" "}
        </MainText>
        <Divider />
        ...
        <Divider />
        <Form.Item
          label="Alohida nakladnoyga chiqarish"
          name="alohida"
...
export default SalesUploaderCheckout;
