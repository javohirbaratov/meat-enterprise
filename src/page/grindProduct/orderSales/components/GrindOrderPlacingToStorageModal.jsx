...
function GrindOrderPlacingToStorageModal(props, ref) {
  useImperativeHandle(ref, () => ({
    onOpen: handleOpenPlacingOrderModal
  }))
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/*Mass*/}
          <MainInputMass status={formStatus} />
...
export default forwardRef(GrindOrderPlacingToStorageModal);
